...
<script>
   ...
   function  myMap() {
      ...
      // 3. jquery ajax method :   ajax()파라미터로 쓸거야 params
      var params = null;
          ...
          //        ]
            $(data).each(
                  function(index, e) {
                     ...
                     //person.name은 person["name"]인 것처럼
                     //label객체 안에 있는거네
...
<script async="true" defer src="https://maps.googleapis.com/maps/api/js?key=AIzaSyA-TcBxG_s2_DmWIDPL9TePT9aXajPWxWA&callback=myMap"></script>
