		...
		<table border="1">
			...
			<tr>
				<td colspan="2" align="center"><input type="button" value="글수정"
					...
					<a href="delete.do?num=${ dto.num }">글삭제</a> <!-- [기억] 답글 버튼 클릭하면           write.do?부모num, 부모그룹 ref, 부모step,부모=depth -->
					<input type="button" value="답글" 
					onclick="location.href='write.do?num=${ dto.num }&ref=${dto.ref }&step=${ dto.step }&depth=${ dto.depth }'"><!-- 답글 달고자 하는 부모 정보도 붙어 -->
