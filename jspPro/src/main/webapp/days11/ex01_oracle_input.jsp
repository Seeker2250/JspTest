...
<script>
   ...
   function  myMap() {
      ...
      var map = new google.maps.Map(mapCanvas, mapOptions);//구글 지도 그리기
...
<script   src="https://maps.googleapis.com/maps/api/js?key=AIzaSyA-TcBxG_s2_DmWIDPL9TePT9aXajPWxWA&callback=myMap"></script>
