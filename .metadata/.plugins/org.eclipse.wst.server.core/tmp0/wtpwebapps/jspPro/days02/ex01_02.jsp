...
<div>
 ...
 <script>
	...
	$(":button[value='사원 확인']").on("click",function(e){
		if($(":checkbox[name=deptno]:checked").length == 0){
			alert("부서 체크하세요.")
			return;
		}
		/*
		let hrefValue = "ex01_emp_02.jsp?";//deptno 10
		...
		*/
		...
		$(":button[value='사원 확인']").on("click",function(e){
			...
			if(checkedDepts.length > 0){
				location.href = `ex01_emp_02.jsp?deptno=${checkedDepts.join('&deptno=')}`;
			}
			location.href = `ex01_emp_02.jsp`;
