  ...
  <table border="1" >
   <tr>
     <td align="right" colspan="6">
         <a href="write.do">글쓰기</a><!-- 경로 원래는 제대로 줘야 해 contextPath부터 -->
     </td>
   </tr>
       ...
       <tr class="data">
         ...
         <td>     
           <c:if test="${ dto.depth gt 0 }">
             ...
             <img src="/jspPro/days13/replyboard/images/arr.gif">
           </c:if>
           ...
           <c:if test="${ dto.newImg }"><!-- 1시간 안 지났으면 이미지 붙여 -->
             <img src="/jspPro/days13/replyboard/images/ico-new.gif">
           </c:if>
         </td>
         <td>  
            <img  width="20px" height="20px" src="/jspPro/days13/replyboard/emoticon/${dto.writer}.png">            
