...
<div>
  <xmp class="code">
         ex05_03.jsp   
         days06 폴더 안에 있는 파일명을 읽어와서 select 태그에 option태그를
         만들어서 추가.         
  ...
  <%
     ...
     /*
     > realPath : C:\E\Class\SS21Class\Workspace\JSPClass\.metadata\.plugins\org.eclipse.wst.server.core\tmp0\wtpwebapps\jspPro\days06 
     */
  ...
  <script>
     ...
     // 꼭 홑따옴표 붙이기~
    <%--  $("#file").val('<%= pfileName %>'); --%> /*이러면 전체 경로가 다 찍혀 */
    $("#file").val('<%=pfileName==null?listFiles[0].getName():pfileName%>');
  </script>
</div> 
</body>
</html>
