...
<body>
	...
	<div>
		<xmp class="code"> ex06_update.jsp </xmp>
		<h2>글수정</h2>
		<form action="update_ok.ss" method="post"
			...
			<table border="1" align="center">
				...
				<tr>
					<td>attach file</td>
					<td>
					<input type="file" name="attachFile" /><!-- 원래꺼 -->
					<input type="text" name="filesystemname" value="${ dto.filesystemname }">
					</td>
				</tr>
				<tr>
					<td colspan="2"><input type="submit" /> 
					<input type="hidden" name="num" value="${dto.num}"> <a href="list.ss">Home</a>
					</td>
				</tr>
			</table>
		</form>
